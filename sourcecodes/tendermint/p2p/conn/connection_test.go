...
func TestMConnectionSend(t *testing.T) {
	...
	// the send.sh queue in a separate goroutine.
...
func TestMConnectionReadErrorUnknownChannel(t *testing.T) {
	...
	// fail to send.sh msg on channel unknown by client
	assert.False(t, mconnClient.Send(0x03, msg))

	// send.sh msg on channel unknown by the server.
...
func TestMConnectionReadErrorUnknownMsgType(t *testing.T) {
	...
	// send.sh msg with unknown msg type
