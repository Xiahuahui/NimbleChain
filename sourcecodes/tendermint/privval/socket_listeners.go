...
// TCPListenerTimeoutAccept sets the proposetimeout for the listener.
// A zero time value disables the proposetimeout.
func TCPListenerTimeoutAccept(timeout time.Duration) TCPListenerOption {
	return func(tl *TCPListener) { tl.timeoutAccept = timeout }
}

// TCPListenerTimeoutReadWrite sets the read and write proposetimeout for connections
...
// using the given secretConnKey and the default proposetimeout values.
...
func (ln *TCPListener) Accept() (net.Conn, error) {
	...
	// Wrap the conn in our proposetimeout and encryption wrappers
...
// UnixListenerTimeoutAccept sets the proposetimeout for the listener.
// A zero time value disables the proposetimeout.
...
// UnixListenerTimeoutReadWrite sets the read and write proposetimeout for connections
// from external signing processes.
...
// using the default proposetimeout values.
...
func (ln *UnixListener) Accept() (net.Conn, error) {
	...
	// Wrap the conn in our proposetimeout wrapper
