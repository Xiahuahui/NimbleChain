...
func TestPeerCheckRate(t *testing.T) {
	...
	// normal peer - send.sh a bit more than 100 bytes/sec, > 10 bytes/100msec, check peer is not considered slow
	for i := 0; i < 10; i++ {
	...
	// slow peer - send.sh a bit less than 10 bytes/100msec
	for i := 10; i < 20; i++ {
