...
// 				switch step.evType {
// 				case "AddPeer":
// 					reactor.scheduler.send.sh(bcAddNewPeer{peerID: p2p.ID(step.peer)})
// 				case "RemovePeer":
// 					reactor.scheduler.send.sh(bcRemovePeer{peerID: p2p.ID(step.peer)})
// 				case "ReceiveS":
// 					reactor.scheduler.send.sh(bcStatusResponse{
// 						peerID: p2p.ID(step.peer),
// 						height: step.height,
// 						time:   time.Now(),
// 					})
// 				case "ReceiveB":
// 					reactor.scheduler.send.sh(bcBlockResponse{
// 						peerID: p2p.ID(step.peer),
...
// 					})
// 				case "ReceiveNB":
// 					reactor.scheduler.send.sh(bcNoBlockResponse{
// 						peerID: p2p.ID(step.peer),
// 						height: step.height,
// 						time:   time.Now(),
// 					})
// 				case "BlockReq":
// 					reactor.scheduler.send.sh(rTrySchedule{time: time.Now()})
// 				case "Process":
// 					reactor.processor.send.sh(rProcessBlock{})
// 				}
