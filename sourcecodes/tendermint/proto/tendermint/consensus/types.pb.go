...
type PDT struct {
	PdtInfo *types.PDTInfo `protobuf:"bytes,1,opt,name=pdt_info,json=pdtInfo,proto3" json:"pdt_info,omitempty"`
}

func (m *PDT) Reset()         { *m = PDT{} }
func (m *PDT) String() string { return proto.CompactTextString(m) }
func (*PDT) ProtoMessage()    {}
func (*PDT) Descriptor() ([]byte, []int) {
	return fileDescriptor_81a22d2efc008981, []int{7}
}
func (m *PDT) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *PDT) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_PDT.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *PDT) XXX_Merge(src proto.Message) {
	xxx_messageInfo_PDT.Merge(m, src)
}
func (m *PDT) XXX_Size() int {
	return m.Size()
}
func (m *PDT) XXX_DiscardUnknown() {
	xxx_messageInfo_PDT.DiscardUnknown(m)
}

var xxx_messageInfo_PDT proto.InternalMessageInfo

func (m *PDT) GetPdtInfo() *types.PDTInfo {
	if m != nil {
		return m.PdtInfo
	}
	return nil
...
type Message_Pdt struct {
	Pdt *PDT `protobuf:"bytes,8,opt,name=pdt,proto3,oneof" json:"pdt,omitempty"`
}
type Message_VoteSetMaj23 struct {
	VoteSetMaj23 *VoteSetMaj23 `protobuf:"bytes,9,opt,name=vote_set_maj23,json=voteSetMaj23,proto3,oneof" json:"vote_set_maj23,omitempty"`
}
type Message_VoteSetBits struct {
	VoteSetBits *VoteSetBits `protobuf:"bytes,10,opt,name=vote_set_bits,json=voteSetBits,proto3,oneof" json:"vote_set_bits,omitempty"`
}
...
func (*Message_Pdt) isMessage_Sum()           {}
...
func (m *Message) GetPdt() *PDT {
	if x, ok := m.GetSum().(*Message_Pdt); ok {
		return x.Pdt
	}
	return nil
}
...
func init() {
	...
	proto.RegisterType((*PDT)(nil), "tendermint.consensus.PDT")
...
var fileDescriptor_81a22d2efc008981 = []byte{
	...
	,
}
...
func (m *PDT) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *PDT) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *PDT) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.PdtInfo != nil {
		{
			size, err := m.PdtInfo.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Message_Pdt) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Message_Pdt) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.Pdt != nil {
		{
			size, err := m.Pdt.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *PDT) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PDT: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PDT: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			if m.PdtInfo == nil {
				m.PdtInfo = &types.PDTInfo{}
			}
			if err := m.PdtInfo.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
