...
func TestTxsAvailable(t *testing.T) {
	...
	// send.sh a bunch of txs, it should only fire once
	...
	// send.sh a bunch more txs. we already fired for this height so it shouldnt fire again
	...
	// send.sh a bunch more txs, it should only fire once
