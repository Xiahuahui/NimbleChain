...
// goroutines can each create their own batches and send.sh them using the same
...
// Create proposetimeout enabled http client
...
// compilation of the batched requests and send.sh them off using the client as a
