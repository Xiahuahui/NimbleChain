...
func (wsc *wsConnection) readRoutine() {
	...
	for {
		...
		default:
			...
			if request.ID == nil {
				wsc.Logger.Debug(
					"WSJSONRPC received a notification, skipping... (please send.sh a non-empty ID if you want to call a method)",
					"req", request,
				)
				continue
			}
...
// If some writes don't set it while others do, they may proposetimeout incorrectly
