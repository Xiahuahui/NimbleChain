...
func TestReactorBroadcastEvidence(t *testing.T) {
	...
	// send.sh a bunch of valid evidence to the first reactor's evpool
...
// Reactor 1 which is ahead receives a number of evidence. It should only send.sh the evidence
...
// This tests aims to ensure that reactors don't send.sh evidence that they have committed or that ar
