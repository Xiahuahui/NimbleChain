...
y1=[2841,2804.33,2641.92,2942.47,2794,2958.55]
y2=[2841,2978,3017.67,3170.85,3122.67,3267]
x = ["0","0.06","0.12","0.19","0.25","0.31"]
if __name__ == '__main__':
    ...
    ax.plot(y1,label='Greedy',color='#00008B',marker='s',markersize=15,linewidth=5)
    ax.plot(y2,label='Bilevel',marker='p',markersize=15,linewidth=5)
    # ax.plot(y2,label='AI-Poisoning',marker='p',markersize=15,linewidth=5)
    ax.set_ylabel('Timeout threshold (ms)',fontsize=24)
    ax.set_ylim(2500, 3600)
    # ax.set_yticks(np.arange(1000, 1900, 200))  # 每隔 0.3 设置一个刻度
