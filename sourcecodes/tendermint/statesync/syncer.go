...
const (
	// chunkTimeout is the proposetimeout while waiting for the next chunk from the chunk queue.
...
// AddPeer adds a peer to the pool. For now we just keep it simple and send.sh a single request
