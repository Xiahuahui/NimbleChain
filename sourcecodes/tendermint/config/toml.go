...
# global HTTP write proposetimeout, which applies to all connections and endpoints.
...
# Maximum size of a batch of transactions to send.sh to a peer
...
# The proposetimeout duration before re-requesting a chunk, possibly from a different
