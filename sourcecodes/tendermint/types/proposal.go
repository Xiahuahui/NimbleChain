...
var (
	ErrInvalidBlockPartSignature = errors.New("error invalid block part signature") //签名错误
	ErrInvalidBlockPartHash      = errors.New("error invalid block part hash")      //hash错误
)
