...
// TestBeginBlockValidators ensures we send.sh absent validators list.
...
// TestBeginBlockByzantineValidators ensures we send.sh byzantine validators list.
...
// TestEndBlockValidatorUpdates ensures we update validator set and send.sh an event.
