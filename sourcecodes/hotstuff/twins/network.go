...
func (d fixedDuration) ViewSucceeded(view hotstuff.View,propose hotstuff.ID) {}
func (d fixedDuration) ViewLog(view hotstuff.View)       {}
func (d fixedDuration) ViewTimeout(view hotstuff.View)   {}
func (d fixedDuration) GetTimeout() float64{return 0}